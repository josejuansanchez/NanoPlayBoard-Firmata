/*
  NanoPlayBoard Firmata Firmware

  Customized version of the Firmata firmware for NanoPlayBoard experimental
  and educational board. Based on the CircuitPlaygroundFirmata firmware.
  ...
  Copyright (C) 2016 José Juan Sánchez.  All rights reservered.
